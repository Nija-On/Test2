...
import net.mcreator.unitquegems.procedures.AirGunRangedItemUsedCouldowonProcedure;
...
public class AirGunItem extends UnitqueGemsModElements.ModElement {
	@ObjectHolder("unitque_gems:air_gun")
	public static final Item block = null;
	@ObjectHolder("unitque_gems:entitybulletair_gun")
	public static final EntityType arrow = null;
	public AirGunItem(UnitqueGemsModElements instance) {
		super(instance, 30);
	}
	...
	public void initElements() {
		...
		elements.entities.add(() -> (EntityType.Builder.<ArrowCustomEntity>create(ArrowCustomEntity::new, EntityClassification.MISC)
				...
				.size(0.5f, 0.5f)).build("entitybulletair_gun").setRegistryName("entitybulletair_gun"));
	}
	...
	public static class ItemRanged extends Item {
		public ItemRanged() {
			super(new Item.Properties().group(UniqueGemsItemGroup.tab).maxDamage(1000));
			setRegistryName("air_gun");
		}
		...
		public void onUsingTick(ItemStack itemstack, LivingEntity entityLiving, int count) {
			...
			if (!world.isRemote && entityLiving instanceof ServerPlayerEntity) {
				...
				if (true) {
					ArrowCustomEntity entityarrow = shoot(world, entity, random, 2f, 0, 4);
					...
					entityarrow.pickupStatus = AbstractArrowEntity.PickupStatus.DISALLOWED;
					{
						...
						AirGunRangedItemUsedCouldowonProcedure.executeProcedure($_dependencies);
					}
	...
	public static class ArrowCustomEntity extends AbstractArrowEntity implements IRendersAsItem {
		...
		public ItemStack getItem() {
			return new ItemStack(AireElementItem.block, (int) (1));
		}
