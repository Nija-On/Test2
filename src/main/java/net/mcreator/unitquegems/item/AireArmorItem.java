...
public class AireArmorItem extends UnitqueGemsModElements.ModElement {
	@ObjectHolder("unitque_gems:aire_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("unitque_gems:aire_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("unitque_gems:aire_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("unitque_gems:aire_armor_boots")
	public static final Item boots = null;
	public AireArmorItem(UnitqueGemsModElements instance) {
		super(instance, 38);
	}
	...
	public void initElements() {
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(UniqueGemsItemGroup.tab)) {
			...
			public void addInformation(ItemStack itemstack, World world, List<ITextComponent> list, ITooltipFlag flag) {
				...
				list.add(new StringTextComponent("Armure complete Pouvoir: Te permes de vol\u00E9"));
				list.add(new StringTextComponent("Am\u00E9liore ta vision et les item du type Air"));
			}

			@Override
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "unitque_gems:textures/models/armor/aire_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("aire_armor_helmet"));
		...
		}.setRegistryName("aire_armor_chestplate"));
		...
		}.setRegistryName("aire_armor_leggings"));
		...
		}.setRegistryName("aire_armor_boots"));
	}
}
