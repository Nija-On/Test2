...
package net.mcreator.unitquegems.world.structure;
...
public class SkycityStructure extends UnitqueGemsModElements.ModElement {
	public SkycityStructure(UnitqueGemsModElements instance) {
		super(instance, 26);
	}
				...
				if ((random.nextInt(1000000) + 1) <= 1000) {
					...
					for (int a = 0; a < count; a++) {
						...
						Template template = ((ServerWorld) world.getWorld()).getSaveHandler().getStructureTemplateManager()
								.getTemplateDefaulted(new ResourceLocation("unitque_gems", "skycity2"));
						if (template == null)
							return false;
