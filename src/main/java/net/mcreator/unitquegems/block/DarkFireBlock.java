...
public class DarkFireBlock extends UnitqueGemsModElements.ModElement {
	@ObjectHolder("unitque_gems:dark_fire")
	public static final Block block = null;
	public DarkFireBlock(UnitqueGemsModElements instance) {
		super(instance, 57);
	}
	...
	public void init(FMLCommonSetupEvent event) {
		FlowersFeature feature = new DefaultFlowersFeature(BlockClusterFeatureConfig::deserialize) {
			...
			public boolean place(IWorld world, ChunkGenerator generator, Random random, BlockPos pos, BlockClusterFeatureConfig config) {
				...
				if (dimensionType == FireDimansionDimension.type)
	...
	public static class BlockCustomFlower extends FlowerBlock {
		public BlockCustomFlower() {
			super(Effects.SATURATION, 0, Block.Properties.create(Material.PLANTS).doesNotBlockMovement().sound(SoundType.CLOTH)
					.hardnessAndResistance(-1, 3600000).lightValue(11));
			setRegistryName("dark_fire");
		}
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(Blocks.PISTON_HEAD, (int) (0)));
		}
