...
public class RanforcedStoneBlock extends UnitqueGemsModElements.ModElement {
	@ObjectHolder("unitque_gems:ranforced_stone")
	public static final Block block = null;
	public RanforcedStoneBlock(UnitqueGemsModElements instance) {
		super(instance, 18);
	}
	...
	public static class CustomBlock extends Block {
		public CustomBlock() {
			super(Block.Properties.create(Material.ROCK).sound(SoundType.STONE).hardnessAndResistance(15f, 12f).lightValue(0).harvestLevel(3)
					.harvestTool(ToolType.PICKAXE));
			setRegistryName("ranforced_stone");
		}
